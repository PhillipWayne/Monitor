...
namespace MonitorPorts
{
    class SettingSaves
    {
        ...
        List<string> _listSourIPAndPort = new List<string>();//源IP-端口
        List<string> _listDestIPAndPort = new List<string>();//目的IP-端口

        List<string> _listSourIP = new List<string>();//源IP
        List<string> _listDestIP = new List<string>();//目的IP

        Dictionary<string ,string> _dicIPPortProperty;//IP-端口，车/地
        Dictionary<string, string> _dicIPProperty;//IP，车/地
